...
-- sujet
INSERT INTO sujet(suj_name, suj_hide, suj_tag)  values 
('Comment mon chat peut-il devenir cool sur internet ?', false, 1),
('Comment adopter un chat ?', true, 1),
('J aime les chevaux.', false, 3),
('J aime les chevaux - 2.', false, 3),
('Ou pourrais-je trouver une cage pour mon rat domestique ?', false, 6),
('Comment les habitants de la cité de villiers ce sont ensortie avec l invasion des rats ?', false, 6);
