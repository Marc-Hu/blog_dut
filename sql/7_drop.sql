...
drop function if exists modifName(integer, varchar);
drop function if exists modifDesc(integer, text);
drop function if exists modifMessage(integer, text);
drop function if exists modifPassword(integer, varchar);
drop function if exists modifEmail(integer, varchar);
